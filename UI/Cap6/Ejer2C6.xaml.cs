...
{
    public partial class Ejer2C6 : Window
    {
        ...
        public void Click_btnAgregar(object sender, RoutedEventArgs e)
        {
            ...
            else
            {
                ...
                TextBoxCalificacionMinimaSalon.Text = Convert.ToString(minima);
            }
        }
        public void Click_btnLimpiar(object sender, RoutedEventArgs e)
        {
            ...
            TextBoxCalificacionMinimaSalon.Text = "";
            minima = 10.0f;
        }
    }
}